...
function build_tree(selector, root, options) {  // , taxaToObj, maxCount) {
    ...
    var circleSize = options.barheight // radius
    var circleFill = "gray"
    ...
    */
	...
	.each(function(nd) {
	    if (!nd.name.startsWith("internal")&&nd.event!=undefined) {
	...
	if(d.num_cell_under_this_node!=undefined){
		htmlOutput += "<br><br><b>cells under this node:</b><br>" + d.num_cell_under_this_node
	}
	if (d.cellType!=undefined){
		htmlOutput += "<br><br><b>Cell type:</b><br>" + d.cellType
	}
	if (d.mutation!=undefined){
		htmlOutput += "<br><br><b>Mutation at this node:</b><br>" + d.mutation.split("_").join(", ")
		//htmlOutput += "<br><br><b>Mutation at this node (early|late):</b><br>" + d.mutation.split("_").slice(1, 4).join(", ")+"|"+ d.mutation.split("_").slice(5,9).join(", ")
		htmlOutput += "<br><br><b>Cumulated mutations  (* for no mutation):</b><br>" + "Early mutation sites: </b><br>"+d.commonEvent.split("_").slice(0, 4).join(", ")+"</b><br> Late mutation sites: </b><br>"+d.commonEvent.split("_").slice(4,11).join(", ")+"</b><br>"
	}
	//htmlOutput += "<br><br><b>Allele (inferred for internal nodes):</b><br>" + d.event.split("_").join(", ")
	if(d.sum_cluster_expression_distance!=undefined){
		htmlOutput += "<br><br><b>Cluster distance:</b><br>" + d.sum_cluster_expression_distance
	}
	//htmlOutput += "<br><br><b>grafted:</b><br>" + d.grafted 
	htmlOutput += "<br><br><b>Proportion of sampled organs / organism:</b><br>"
